      ...
      <div className="container mx-auto px-4 sm:px-8 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <h3 className="font-bold text-xl tracking-tight text-primary">{siteConfig.name}</h3>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/solutions" className="text-sm text-muted-foreground hover:text-primary">Solutions</Link>
              </li>
              <li>
                <Link href="/pricing" className="text-sm text-muted-foreground hover:text-primary">Pricing</Link>
              </li>
              <li>
                <Link href="/request-demo" className="text-sm text-muted-foreground hover:text-primary">Request Demo</Link>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t mt-12 pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-center md:text-left">
          ...
          <div className="text-sm text-muted-foreground flex items-center justify-center gap-1">
            ...
            <a href="https://www.progremmo.online/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline font-medium ml-1">
              Progremmo
            </a>
          </div>
          <div className="text-sm text-muted-foreground">
            Contact: {siteConfig.company.supportEmail}
          </div>
        </div>
      </div>
    </footer>
